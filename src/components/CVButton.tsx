...
const CVButton: React.FC<CVButtonProps> = ({ 
  ...
  return (
    <a 
      ...
      className={`group relative overflow-hidden rounded-full bg-white dark:bg-white/10 px-5 py-2.5 transition-all duration-300 ease-out border border-black/10 dark:border-white/10 shadow-md hover:shadow-lg hover:border-black/20 dark:hover:border-white/20 ${className}`}
    ...
    >
      ...
      <span className="relative flex items-center justify-center gap-2 text-sm font-medium text-slate-900 dark:text-white">
